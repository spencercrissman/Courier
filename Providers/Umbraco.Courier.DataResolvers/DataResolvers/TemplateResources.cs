    ...
    public class TemplateResources : ItemDataResolverProvider
    {
        ...
        public override void Packaging(Item item)
        {
            ...
            if (!string.IsNullOrEmpty(design))
            {
                ...
                //detecting images in templates
                foreach (
                    string imgFile in Umbraco.Courier.Core.Helpers.Dependencies.ReferencedImageFilessInstring(design))
                {
                    string s = imgFile;
                ...
                //Detecting css files in templates
                foreach (
                    string cssFile in Umbraco.Courier.Core.Helpers.Dependencies.ReferencedStyleSheetsInstring(design))
                {
                    var css = cssFile;
